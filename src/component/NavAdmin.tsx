...
const NavAdmin = (props: Props) => {
    return (
        <div className="h-screen flex items-end justify-end px-4 pb-6">
            ...
            <div className="z-20 fixed top-0 -left-96 lg:left-0 h-screen w-9/12 lg:w-72 bg-white shadow-2xl peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
                <nav role="navigation" className="p-6">
                    <div className="flex items-center gap-4 pb-4">
                        <Link to="/admin"><img className="w-32" src="https://raw.githubusercontent.com/Meschacirung/Tailus-website/f59a4b3ecc1ad9f6a2b0ad9e3fca6f957140cc4d/public/images/logo.svg" alt="tailus-logo" /></Link>
                    </div>
                    <div className="relative">
                        <form className="text-gray-500 focus-within:text-cyan-400 focus-within:bg-white focus-within:shadow rounded search transition duration-300">
                            <div className="relative w-full">
                                ...
                                <input type="search" placeholder="Rechercher" name="search" id="search" className="text-sm text-gray-500 placeholder-gray-500 w-full rounded py-3 pr-4 pl-12 bg-gray-200 bg-opacity-75 outline-none focus:bg-transparent focus:rounded-3xl transition-all" />
                            </div>
                        </form>
                    </div>
                    <div className="mt-4 -mx-4 relative overflow-y-auto overflow-x-hidden h-[85vh]">
                        ...
                        <ul className="space-y-4 mb-12 px-4 mt-8">
                            ...
                            <li>
                                <a href="" className="flex gap-4 text-gray-600 hover:text-gray-800 transition">
                                    <img src="https://raw.githubusercontent.com/Meschacirung/Tailus-website/f59a4b3ecc1ad9f6a2b0ad9e3fca6f957140cc4d/public/images/icons/atom.svg" className="w-6" alt="" />
                                    Atomic css
                                </a>
                            </li>
                            <li>
                                <a href="" className="flex gap-4 text-gray-600 hover:text-gray-800 transition">
                                    <img src="https://raw.githubusercontent.com/Meschacirung/Tailus-website/f59a4b3ecc1ad9f6a2b0ad9e3fca6f957140cc4d/public/images/icons/molecule.svg" className="w-6" alt="" />
                                    Atomic Design
                                </a>
                            </li>
                            <li>
                                <a href="" className="flex gap-4 text-gray-600 hover:text-gray-800 transition">
                                    <img src="https://raw.githubusercontent.com/Meschacirung/Tailus-website/f59a4b3ecc1ad9f6a2b0ad9e3fca6f957140cc4d/public/images/icons/template.svg" className="w-6" alt="" />
                                    Default look
                                </a>
                            </li>
                        </ul>
                        <ul className="space-y-4">
                            <li className="pr-2">
                                <div className="py-2 px-4 text-gray-700 uppercase">
                                    <a href="" className="block">Atoms</a>
                                </div>
                                <ul className="text-sm pb-24">
                                    ...
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Banners</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Buttons</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Button-groups</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Avatar</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Badges</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Checkboxes</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Chips</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">File inputs</a>
                                    </li>
                                    <li>
                                        <a className="block py-2 px-5 hover:text-gray-800 transition" href="">Flags</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div className="z-10 lg:hidden fixed top-0 left-0 w-screen h-screen bg-gray-900 bg-opacity-30 opacity-0 peer-focus:opacity-100 peer:transition duration-200" />
        </div>
